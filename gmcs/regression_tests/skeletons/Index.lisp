...
((:path . "ccomp-illustr6-eng") (:content . "ccomp-illustr6-eng: Clausal comps: Illustrative English"))
...
((:path . "ccomp-pseudo27-vos-extra") (:content . "ccomp-pseudo27-vos-extra: Clausal comps: VOS order, strictly extraposed complement with obligatory complementizer before the clause."))
...
((:path . "ccomp_pseudo35-vin-extra-opt-bef") (:content . "ccomp_pseudo35-vin-extra-opt-bef: Clausal comps: V-initial matrix order, strictly extraposed complement, optional complementizer before the clause."))
...
((:path . "ccomp-pseudo27-vos-extra") (:content . "ccomp-pseudo27-vos-extra: Clausal comps: VOS language with extraposed complement, obligatory complementizer before the clause."))
...
((:path . "v2-vfinal-aux") (:content . "v2-vfinal-aux: German-like subordinate word order with auxiliary clustering with the verb at the end of the embedded clause."))
...
((:path . "clausalcomp-comp-opt") (:content . "clausalcomp-comp-opt: Optional complementizer marking clausal complements."))
((:path . "clausalcomp-comp-oblig-before-after-ovs") (:content . "clausalcomp-comp-oblig-before-after-ovs: Obligatory complementizer attaching either to the left or to the right of the embedded clause, with general matrix word order being OVS."))
((:path . "clausalcomp-comp-oblig-after-svo") (:content . "clausalcomp-comp-oblig-after-svo: Obligatory complementizer attaching to the right of the embedded clause, general matrix order SVO."))
((:path . "clausalcomp-comp-oblig-before-sov") (:content . "clausalcomp-comp-oblig-before-sov: Complementizer attaching to the left of the complement clause with an otherwise SOV matrix word order."))
((:path . "clausalcomp-comp-oblig-svo-embform-subjunct") (:content . "clausalcomp-comp-oblig-svo-embform-subjunct: A clause with a clausal complement (object) with an obligatory complementizer, SVO word order, and subjunctive form required on the embedded verb."))
