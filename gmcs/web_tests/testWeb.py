...
class TenseAspectMoodErrors(unittest.TestCase):
    ...
    def test_tense_aspect_mood_errors(self):
        ...
        driver.find_element_by_css_selector("input[name='noaux-fin-nf']").click()
        driver.find_element_by_css_selector("input[type='button'][value='Add a subtype'][onclick^=\"clone_region('nf-subform'\"]").click() #TODO: nf-subform was changed to form-subtype in choices version 29 (see choices.py)
        driver.find_element_by_css_selector("input[name='nf-subform1_name']").send_keys("Pointless") #TODO: nf-subform was changed to form-subtype in choices version 29 (see choices.py)
        driver.find_element_by_link_text("Word Order").click()
